...
TESTS="edge.test.mjs score.test.mjs golf.test.mjs nfl.test.mjs cfb.test.mjs nflverse.test.mjs cfbfastr.test.mjs statcast.test.mjs bets.test.mjs track.test.mjs clv.test.mjs provenance.test.mjs dom.test.mjs"
