...
TESTS="edge.test.mjs score.test.mjs golf.test.mjs nfl.test.mjs cfb.test.mjs parlay.test.mjs nflverse.test.mjs tendencies.test.mjs cfbfastr.test.mjs statcast.test.mjs bets.test.mjs track.test.mjs clv.test.mjs provenance.test.mjs dom.test.mjs"
