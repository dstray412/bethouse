...
echo "== tests: node --test edge.test.mjs score.test.mjs golf.test.mjs nfl.test.mjs dom.test.mjs =="
node --test edge.test.mjs score.test.mjs golf.test.mjs nfl.test.mjs dom.test.mjs || fail=1
